    ...
    <div class="col-md-7 grid-margin stretch-card mx-auto">
        <div class="card">
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ route('incomes_categories/income_category_store') }}">
                    @csrf
                    <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Category Name</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control @error('category') is-invalid @enderror"
                                id="exampleInputUsername2" placeholder="Hosting,Web_development,other" name="category" value="{{ old('category') }}"
                                required>
                            @error('category')
